...
{
    public function buildForm(FormBuilderInterface $builder, array $options): void /* Définition des divers types de champs pour le fomulaire de commande et des paramètres qui leur sont assignés si besoin */
    {
        $builder
