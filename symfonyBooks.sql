...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 02 fév. 2023 à 21:38
...
INSERT INTO `comments` (`id`, `book_id`, `content`, `active`, `email`, `nickname`, `created_at`, `note`, `rgpd`) VALUES
(29, 1, 'Joli !', 1, 'jojo@mail.fr', 'Jojo', '2023-01-30 23:40:34', 4, 1),
(40, 1, NULL, 1, 'Kiki@psg.quatar', 'Kiki-Buteur', '2023-01-31 18:59:34', 3, 1),
(42, 1, '<b>Pierre Loti</b> dans un pays à l\'heure de la \"révolution\" Meiji\r\n<br />\r\nÀ travers un regard d\'occidental, un peu méprisant, empreint de toute l\'idéologie européenne impérialiste de l\'époque, <b>Pierre Loti</b> décrit le Japon de l\'ère Meiji : Alors que l\'effervescence de la modernisation bat son plein à Yokohama, le reste du pays reste plongé dans les mœurs de l\'époque d\'Edo. Si le ton peut agacer, les descriptions valent bien cette lecture.', 1, 'taneda@mail.fr', 'Taneda', '2023-01-31 22:51:21', NULL, 1),
(45, 8, 'Ouvrage très intéressant sur les services secrets. On apprend leur existence depuis l\'antiquité,comme quoi espion est l\'un des plus anciens métiers au monde. Pour ma part , j\'ai apprécié la description des services secrets notamment durant l\'Antiquité et le Moyen Âge. C\'est un aspect méconnu. En lisant ce livre, j\'ai découvert le rôle des réseaux de renseignement belges durant la première guerre mondiale avec l\'exemple du réseau de la dame blanche ainsi que la participation des femmes dans ces réseaux. Il est décrit aussi la continuité des pratiques de renseignement des services russes du tsarisme au communisme . On découvre l\'histoire des transfuges et taupes des services secrets soviétiques, ce qui montre leur affaiblissement progressif ainsi que le déclin inexorable du système communiste soviétique.', 1, 'turcanl@mail.fr', 'turcanl', '2023-02-01 23:13:14', 4, 1),
(46, 3, 'Que nenni ! de désuétude quand l\'écriture est un don. D\'autres vous impatientent, vous torturent, vous accablent et icelui qui vous entraîne par les flots ; ce Loti « Pêcheur d\'Islande ». C\'est du bel ouvrage vous dis-je. Voilà des gens qui vivent leur vie et aucune autre, soit-elle dure et affligeante et l\'amour si peu donné aussitôt repris. La peur quelque peu allégée par la croyance, la coutume et les us, mais tout de même la vraie vie. Ses lenteurs, ses emballements, ses aléas. Un livre goûteux, des mots avalés, ça glisse et vous entraîne. C\'est beau', 1, 'gertrude@mail.fr', 'Gertrude55', '2023-02-01 23:33:48', 5, 1),
(47, 4, '<b>Albert Londres</b> ne cherchait pas le scoop. Les terrains de ses reportages n\'étaient pas ceux qui faisaient habituellement les choux gras de la presse. Bien au contraire, il traînait dans les zones d\'ombre, dans les lieux perdus de l\'histoire. Dans <i>Dante n\'avait rien vu, Biribi</i> , c\'est aux pénitenciers militaires des colonies nord-africaines qu\'il s\'attaque. Des territoires suffisamment éloignés de la métropole et des centres de décisions pour vivre à l\'abri de tout regard. On pouvait y pratiquer la torture et le crime en toute impunité. Ils étaient l\'œuvre surtout des petits grades, les sergents, les pires de tous, parce qu\'ils étaient occupés par des abrutis de première classe. Pour eux, s\'acharner sur un prisonnier à coup de fouet et de bottes, ce n\'était pas une indignité, mais un moyen de justifier leur rôle.\r\n<br /><br />\r\nLes exactions énumérées par <b>Londres</b> pourraient créer le vertige, mais le reporter, à la manière de <b>Voltaire</b>, avait le don de la formule ironique. Comme l\'indique le titre de l\'ouvrage, <b>Londres</b> prenait continuellement de la distance avec les faits pour mieux les dénoncer et dévoiler leur atrocité. Je me suis même surpris parfois à sourire à certains passages. C\'était peut-être cynique de ma part, mais le rire n\'est-il pas un moyen d\'accepter une réalité souvent cruelle et douloureuse ?', 1, 'chartel@mail.fr', 'chartel', '2023-02-02 14:57:48', 5, 1);
...
('DoctrineMigrations\\Version20230130215430', '2023-01-30 21:54:46', 142),
('DoctrineMigrations\\Version20230130215824', '2023-01-30 21:58:35', 148);
...
(13, 'Michel', 'Vaillant', NULL, NULL, '24 rue des 24 heures du Mans', 'Le mans', 72000, 'michelvaillant@mail.fr', '66 66 66 66 66', '<ul>\r\n                                                                            <li>\r\n                                            <i>Nous</i> de  <b>Evguéni Zamiatine</b>   | Prix unitaire :  8.00 €  | Quantité : 3 | Total  24 €   \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>Le Maître du Haut Château</i> de  <b>Philippe K. Dick</b>   | Prix unitaire :  8.50 €  | Quantité : 2 | Total  17 €   \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>Blade runner: Les androïdes rêvent-ils de moutons électriques ?</i> de  <b>Philippe K. Dick</b>   | Prix unitaire :  8.00 €  | Quantité : 4 | Total  32 €   \r\n                                        </li>\r\n                                                                    </ul>', 32788, 9, '73.00', 'Chèque', 1),
(14, 'Paul', 'Valentin', 43, 'Appartement 6', '10 rue des Brigades du Tigre', 'Paris', 75000, 'paulvalentin@mail.fr', '77 77 77 77 77', '<ul>\r\n                                                                            <li>\r\n                                            <i>L\'Europe de 1815 à nos jours</i> de  <b>Georges-Henri Soutou</b>   | Prix unitaire :  30.00 €   | Quantité : 1 | Total  30 €    \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>Histoire des coureurs de bois</i> de  <b>Gilles Havard</b>   | Prix unitaire :  12.00 €   | Quantité : 3 | Total  36 €    \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>Kang Sheng - Le maître espion de Mao</i> de  <b>Rémi Kauffer</b>  <b>Roger Faligot</b>   | Prix unitaire :  10.00 €  | Quantité : 2 | Total  20 €   \r\n                                        </li>\r\n                                                                    </ul>', 32789, 6, '86.00', 'Carte', 1),
(15, 'Jean', 'Valjean', 57, 'Appartement 3', '12 rue des Misérables', 'Paris', 75000, 'jeanvaljean@mail.fr', '99 99 99 99 00', '<ul>\r\n                                                                            <li>\r\n                                            <i>Voyages</i> de  <b>Pierre Loti</b>   | Prix unitaire :  30.00 €   | Quantité : 2 | Total  60 €    \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>Dante n\'avait rien vu</i> de  <b>Albert Londres</b>   | Prix unitaire :  7.33 €  | Quantité : 1 | Total  7.33 €   \r\n                                        </li>\r\n                                                                    </ul>', 32790, 3, '67.33', 'Chèque', 1),
(16, 'Greg', 'Boyington', NULL, NULL, '10 rue des têtes brûlées', 'Bordeaux', 33000, 'gregboyington@mail.fr', '11 11 11 11 11', '<ul>\r\n                                                                            <li>\r\n                                            <i>Histoire mondiale des services secrets</i> de  <b>Rémi Kauffer</b>   | Prix unitaire :  14.90 €  | Quantité : 2 | Total  29.8 €   \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>Les Maquisards</i> de  <b>Fabrice Grenard</b>   | Prix unitaire :  26.00 €  | Quantité : 1 | Total  26 €   \r\n                                        </li>\r\n                                                                    </ul>', 32791, 3, '55.80', 'Virement', 1),
(17, 'Wyatt', 'Earp', 40, NULL, 'Old Kindersley Corral', 'Tombstone', 85638, 'wyattearp@mail.fr', '00 00 00 00 00', '<ul>\r\n                                                                            <li>\r\n                                            <i>Histoire de l\'amerique francaise</i> de  <b>Gilles Havard</b>  <b>Cécile Vidal</b>   | Prix unitaire :  14.00 €  | Quantité : 2 | Total  28 €   \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>Histoire des coureurs de bois</i> de  <b>Gilles Havard</b>   | Prix unitaire :  12.00 €   | Quantité : 2 | Total  24 €    \r\n                                        </li>\r\n                                                                            <li>\r\n                                            <i>L\'Amérique fantôme: Les aventuriers francophones du Nouveau Monde</i> de  <b>Gilles Havard</b>   | Prix unitaire :  13.00 €  | Quantité : 1 | Total  13 €   \r\n                                        </li>\r\n                                                                    </ul>', 32792, 5, '65.00', 'Virement', 1);
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_5F9E962A16A2B381` (`book_id`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `FK_5F9E962A16A2B381` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`);
COMMIT;
